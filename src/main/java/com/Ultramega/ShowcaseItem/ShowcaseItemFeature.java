...
public class ShowcaseItemFeature {
	...
	public static void keyboardEvent(ScreenEvent.KeyPressed.Pre event) {
		...
		if(InputConstants.isKeyDown(mc.getWindow().getWindow(), ModKeyBindings.SHOWCASE_ITEM.getKey().getValue()) && keyModifierPressed(mc) && screen instanceof AbstractContainerScreen<?> gui) {
